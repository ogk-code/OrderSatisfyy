...
*/
        ...
        .hrdop {width: 68,6%; margin: 50px 16% 25px 16%;}
...
<div class="body-container">
    <div class="content">
        <h1 class="logo">ORDER/SATISFY</h1><br>
        <h2>Изменение статуса заказа</h2>
        Статус заказа "{Название}" был изменен на "{статус}"!
        <br><br>
        <div class="row">
            <div class="col align-self-center">
                <form style="border: 1px solid grey; border-radius: 0.25rem; padding: 15px" action="" method="post">
                    <div class="row">
