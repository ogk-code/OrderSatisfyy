                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-sm-0">
                            ...
                            <div class="text-sm op-5">
                                <a class="text-black mr-2" href="/my-orders?c={{getCatId($order->sub_category_id)}}&sc={{$order->sub_category_id}}">#{{getCatName($order->sub_category_id)}}#{{getSubCatName($order->sub_category_id)}}</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 op-7">
                            <div class="row text-center op-7">
                                ...
                                <div class="col px-2">
                                    ...
                                    <span data-id="{{$order->id}}" style="color: #d9232d; cursor: pointer" class="d-block text-sm delete">
                                        Удалить
                                    </span>
                                </div>
                            </div>
