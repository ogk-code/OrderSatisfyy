...
Route::get('/confirm{id}', [\App\Http\Controllers\HomeController::class, 'ConfirmAction']);
Route::get('/reject{id}', [\App\Http\Controllers\HomeController::class, 'RejectAction']);
